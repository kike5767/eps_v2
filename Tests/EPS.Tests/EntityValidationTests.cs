...
namespace EPS.Tests
{
    ...
    public class PagoTests
    {
        ...
        public void Fecha_IsRequired()
        {
            ...
            // DateTime tiene valor por defecto (DateTime.MinValue), así que la validación pasa
            var res = ValidationHelper.Validate(m);
            Assert.Empty(res);
        }
    }
    ...
    public class CitaTests
    {
        ...
        public void Fecha_IsRequired()
        {
            ...
            // Fecha tiene valor por defecto, así que la validación pasa
            var res = ValidationHelper.Validate(m);
            Assert.Empty(res);
        }
        ...
        public void Hora_IsRequired()
        {
            ...
            // Hora tiene valor por defecto, así que la validación pasa
            var res = ValidationHelper.Validate(m);
            Assert.Empty(res);
        }
    }
